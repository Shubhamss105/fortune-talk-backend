...
exports.astrologersWalletBalance = async function (req, res) {
  try {
    const { astrologerId } = req.body;
...
// exports.recommendedAstrologers = async function (req, res) {
//     try {
...
// // end chat
// exports.endChat = async function (req, res) {
//   try {
//     const { customerId, astrologerId } = req.body;
...
// exports.astrologerChatHistory = async function(req, res) {
//   try {
...
// exports.updateOngoingChatById = async function(req, res) {
//   try {
//     const { chatId } = req.params;
//     const { astrologer, customer, timeInSeconds } = req.body;
...
// update waiting list
// exports.updateWaitingListEntry = async function(req, res) {
//   try {
